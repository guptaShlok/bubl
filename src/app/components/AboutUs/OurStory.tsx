  ...
  return (
    <>
      <main className="max-h-screen px-[6vw] -mt-[3vw] w-full relative">
        ...
        <div className="flex flex-col-reverse md:flex-row justify-center space-x-7 items-center md:items-center gap-4 md:mt-6 mt-3 mx-auto">
          {/* Content block */}
          <div className="w-1/2 flex flex-col justify-around  text-center md:text-left text-[clamp(0.8rem,1.6vw,2rem)] font-normal text-black">
            <p className="mt-4">
            ...
            <p>
              In 2024,{" "}
              <span className="font-semibold">Bubl. Technologies India </span>
              was established to bring this life-saving innovation to one of the
              world&#39;s most affected regions.
            </p>
          </div>
          {/* Image block */}
          <div className="w-full md:w-1/2 rounded-2xl shrink-0 flex justify-center md:justify-center overflow-hidden pr-0 md:pr-2">
            <Image
